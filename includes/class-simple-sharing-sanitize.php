...
class Simple_Sharing_Sanitize {
	...
	public function clean() {
		...
		switch ( $this->type ) {
			...
			//case 'array' 			: $santized = $this->sanitize_array( $this->data ); break;
	...
	public function set_type( $type ) {
		...
		if ( empty( $type ) ) {
			...
			$check = new WP_Error( 'forgot_type', __( 'Specify the data type to sanitize.', 'simple-sharing' ) );

		}

		if ( is_wp_error( $check ) ) {

			wp_die( $check->get_error_message(), __( 'Forgot data type', 'simple-sharing' ) );
