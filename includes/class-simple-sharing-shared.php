...
class Simple_Sharing_Shared {
	...
	public function get_button_list() {
		...
		return array( 'Buffer', 'Delicious', 'Digg', 'Email', 'Facebook', 'Google', 'LinkedIn', 'Pinterest', 'Reddit', 'Stumbleupon', 'tumblr', 'Twitter', 'VK', 'Xing' );
	...
	public function get_svg( $button ) {
		...
		switch ( $button ) {
			...
			case 'Buffer' 		: $return = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="buffer"><path d="M9.7.5c.3 0 .6 0 .9.1 2.8 1.3 5.6 2.6 8.5 4 .1.1.2.1.2.3 0 .2-.1.2-.3.3-2.8 1.3-5.7 2.6-8.5 4-.4.1-.8.1-1.2 0-2.8-1.3-5.7-2.6-8.5-4 0-.1-.1-.2-.1-.4 0-.1.1-.2.3-.3C3.7 3.3 6.4 2 9.1.7c.2-.1.4-.2.6-.2zM2.8 8.9c.3-.1.7 0 1 .1 1.8.9 3.7 1.7 5.5 2.6.4.2.9.2 1.3.1 1.9-.9 3.7-1.7 5.6-2.6.4-.2 1-.2 1.4 0 .5.2 1 .5 1.5.7.1.1.3.2.2.3 0 .1-.2.2-.3.3-2.8 1.3-5.6 2.6-8.5 3.9-.4.2-.9.2-1.4-.1-2.8-1.3-5.5-2.6-8.3-3.9-.1-.1-.3-.1-.3-.3 0-.1.1-.2.2-.3l1.2-.6c.4 0 .6-.2.9-.2z"/><path d="M2.9 14c.3 0 .6 0 .9.2 1.8.8 3.6 1.7 5.5 2.5.4.2.9.2 1.3.1 1.9-.9 3.9-1.8 5.8-2.7.4-.2.9-.1 1.3.1.5.2 1 .5 1.5.7.1.1.2.2.1.4-.1.1-.3.2-.5.3-2.7 1.3-5.4 2.5-8.1 3.8-.4.2-.9.2-1.3.1-2.8-1.3-5.5-2.6-8.3-3.9-.2-.1-.3-.1-.4-.3-.1-.1 0-.3.2-.3.4-.2.8-.4 1.3-.6.2-.2.4-.4.7-.4z"/></svg>'; break;
			case 'Delicious' 	: $return = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="delicious"><path d="M19.5 15.9c0 2-1.6 3.6-3.6 3.6H4.1c-2 0-3.6-1.6-3.6-3.6V4.1C.5 2.1 2.1.5 4.1.5H16c2 0 3.6 1.6 3.6 3.6v11.8zm-.8-5.9H10V1.3H4.1c-1.5 0-2.8 1.2-2.8 2.8V10H10v8.7h5.9c1.5 0 2.8-1.2 2.8-2.8V10z"/></svg>'; break;
			case 'Digg' 		: $return = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="digg"><path d="M5.2 4.1v9.5H.1V6.8h3.2V4.1h1.9zM3.3 8.4H2.1V12h1.2V8.4zM6 6h2V4H6v2zm0 7.6h2V6.8H6v6.8zm8-6.8v9.1H8.8v-1.6H12v-.8H8.8V6.8H14zm-2 1.6h-1.2V12H12V8.4zm7.9-1.6v9.1h-5.1v-1.6H18v-.8h-3.2V6.8h5.1zm-2 1.6h-1.2V12h1.2V8.4z"/></svg>'; break;
